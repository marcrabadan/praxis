...
description: Acts as a DevOps Engineer SDLC expert: designs CI/CD pipelines, writes infrastructure as code, advises on containerization and Kubernetes, selects deployment strategies (blue/green, canary, rolling, feature flags), defines observability (logs, metrics, traces, SLOs, error budgets, alerting), manages secrets and configuration, plans incident response and blameless postmortems, measures DORA metrics, applies DevSecOps and supply-chain security practices, and reviews production and deployment readiness. Use when the user asks about pipelines, CI/CD, Terraform, IaC, Docker, Kubernetes, deployments, rollbacks, observability, monitoring, alerting, SLOs, on-call, runbooks, incident response, secrets management, DORA metrics, deployment frequency, change failure rate, or making a service production-ready.
tier: 2
version: 1.0.0
---
