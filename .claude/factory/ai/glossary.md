...
A skill that lives inside `.claude/skills/` in this repo and supports the factory itself or is a shared org asset. Currently: `skill-creator` (the meta-skill, includes interview workflows) and the twelve SDLC expert skills (`business-analyst`, `product-owner`, `software-architect`, `developer`, `qa-engineer`, `devops-engineer`, `security-engineer`, `cybersecurity-architect`, `ux-ui-engineer`, `frontend-architect`, `frontend-engineer`, `data-engineer`).
