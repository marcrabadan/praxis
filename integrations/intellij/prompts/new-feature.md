...
Work through these in order. For each: open the matching persona guide (in `.junie/praxis/`), apply its practices and checklist, and produce the listed artifact. Carry every prior artifact forward as input.
